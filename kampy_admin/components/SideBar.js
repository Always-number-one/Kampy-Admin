        ...
        <div className="p-7 w-1/2  h-screen bg-gray-900  z-20 fixed top-0 -left-100 lg:left-0 lg:w-60 peer-focus:left-0 peer:transition ease-out delay-200 duration-200" >
          <div className="flex flex-col justify-start item-center">
            ...
            <div className=" my-4 border-b border-gray-100 pb-4">
              ...
              <Link href="/shop">
              <a className="flex  mb-2 justify-start items-center gap-4 pl-5 hover:bg-gray-900 p-2 rounded-md group cursor-pointer hover:shadow-lg m-auto">
                <BiShoppingBag className="text-2xl text-gray-600 group-hover:text-white " />
                <h3 className="text-base text-white group-hover:text-amber-300 font-semibold ">
                 Shop
                </h3>
              </a>
            ...
            <Link href="/">
            <div className=" my-4">
              <div className="flex mb-2 justify-start items-center gap-4 pl-5 border border-gray-200  hover:bg-gray-900 p-2 rounded-md group cursor-pointer hover:shadow-lg m-auto color: white">
              <FiLogOut className="text-2xl text-gray-600 group-hover:text-white " />
              <h3 className="text-base text-white group-hover:text-amber-300 font-semibold ">  Log Out </h3>
